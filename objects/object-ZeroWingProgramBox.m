...
@implementation Definitions(fjekwlfmkldsmfkldsjflkfjdskfjksdfjdksjfksd)
+ (id)testZeroWingProgramBox
{
    id obj = [@"ZeroWingProgramBox" asInstance];
...
- (void)drawInBitmap:(id)bitmap rect:(Int4)r
{
    ...
    if (_okText) {
        if (_eof) {
            ...
            textRect.y += 1;
            [bitmap drawBitmapText:text centeredInRect:textRect palette:_textPalette];
        }
    }
