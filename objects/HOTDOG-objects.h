...
@interface NSObject(VHIEVHakvquMpRXqTBbpBFMLOVMbDLe)
- (id)init;
- (int)preferredWidth;
- (int)preferredHeight;
...
- (void)scramble;
+ (char)pokerCharForRank:(int)rank;
- (id)pokerHandDescription;
- (int)pokerCardRank:(int)index;
- (int)pokerCardSuit:(int)index;
- (BOOL)pokerHasRank:(int)rank suit:(int)suit;
- (int)pokerCountSuit:(int)match;
- (int)pokerCountRank:(int)match;
- (id)pokerFlush;
- (id)pokerWheel;
- (id)pokerStraight:(int)highest;
- (id)pokerStraight;
- (id)pokerQuads;
- (id)pokerFullHouse;
- (id)pokerTrips;
...
- (id)pokerPreflopHand;
- (id)pokerSuitedCards;
- (id)pokerPreflopCommentary;
- (id)pokerFlopCommentary;
- (id)pokerCommentary;
- (id)init;
- (void)reset;
- (void)deal;
...
- (void)handleMouseMoved:(id)event;
- (void)handleMouseUp:(id)event;
- (void)drawCard:(int)card x:(int)x y:(int)y;
- (id)handTextForPlayer:(int)player;
- (void)logHandToFile;
- (void)logHandToFile:(id)path;
- (id)init;
- (int)preferredWidth;
- (int)preferredHeight;
- (void)beginIteration:(id)event rect:(Int4)r;
