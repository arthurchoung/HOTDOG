...
@end
static char *brownPotionPalette =
". #E09C20\n"
"X #a3826c\n"
"o #F8FCF8\n"
"O #ffffff\n"
...
"     bbbbbb     \n"
;
@implementation Definitions(fnmjkdfsjkfsdjkeklwfmklsdmfksdkfmdfjkjk)
+ (id)BrownPotionMenuItem
{
    id pixels = nsfmt(@"%s", brownPotionPixels);
    id palette = nsfmt(@"%s", brownPotionPalette);
    id highlightedPalette = palette;
